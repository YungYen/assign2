  ...
  switch (gameState){
    ...
    case GAME_RUN:
        ...
        frogY = height-32;
         ...
         // car1 hitTest//
         if((frogX+16 >= leftCar1X)&&(frogX-16 <= leftCar1X)&&(frogY == leftCar1Y)){
           currentTime = millis();
         ...
         // car3 hitTest
         if((frogX+16 >= rightCar1X)&&(frogX-16 <= rightCar1X)&&(frogY == rightCar1Y)){
           currentTime = millis();
           image(imgDeadFrog, frogX, frogY);
           life--;
           gameState = FROG_DIE;
         ...
         // car4 hitTest
         if((frogX+16 >= rightCar2X)&&(frogX-16 <= rightCar2X)&&(frogY == rightCar2Y)){
           currentTime = millis();
           image(imgDeadFrog, frogX, frogY);
           life--;
           gameState = FROG_DIE;
